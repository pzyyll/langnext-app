...
export type NavIconId = "translate" | "book" | "history" | "neurology" | "settings";
...
/** Primary sidebar links (Translate / Profiles / History / Models). Settings is rendered at the footer. */
