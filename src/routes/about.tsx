    ...
    <div className="space-y-6">
      <section className="space-y-2">
        ...
        <p className="max-w-2xl text-sm leading-6 text-slate-600 dark:text-slate-300">
          Starter desktop app scaffolded for local product work. Frontend lives
          in <code className="text-xs">src/</code>, native shell and Rust
          commands live in <code className="text-xs">src-tauri/</code>.
        </p>
      </section>
