...
const zhCN = {
	...
	models: {
		...
		editModelConfig: {
			...
			maxTokens: "最大 Tokens",
			contextLimit: "上下文上限",
			contextLimitHint: "模型能力上限，单位为 token。默认值：131072。",
			outputLimit: "输出上限",
			outputLimitHint: "模型输出能力上限。默认值：32768。",
			requestMaxTokens: "请求最大 Tokens",
			requestMaxTokensHint: "所选 Profile 未设置最大 token 数时使用此值。",
			tokens: "{{count}} tokens",
			save: "保存更改",
		},
		syncNever: "尚未同步",
