...
const en = {
  ...
  ocr: {
    ...
    provider: {
      baidu: "Baidu OCR",
      baiduShort: "Baidu",
      baiduDescription: "Baidu cloud OCR with API Key and Secret Key.",
      ai: "AI OCR",
      aiShort: "AI",
      aiDescription: "Vision model OCR using a configured provider model and prompts.",
    },
    add: {
      title: "Add OCR service",
      description: "Choose a provider type. Credentials and prompts are edited after create.",
      create: "Create",
      loadingModels: "Loading models…",
