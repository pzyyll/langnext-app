...
const en = {
	...
	translate: {
		...
		streamLabel: "Stream",
		streamAria: "Use streaming translation",
	...
	models: {
		...
		apiTypeCol: "API Type",
		apiTypeInherit: "Channel default",
		...
		editModelConfig: {
			...
			contextLimitHint: "Model capability limit in tokens. Default: 131072.",
			outputLimit: "Output Limit",
			outputLimitHint: "Model output capability limit. Default: 32768.",
			requestMaxTokens: "Request Max Tokens",
			requestMaxTokensHint: "Used when the selected profile does not set Max Tokens.",
			tokens: "{{count}} tokens",
			save: "Save Changes",
		},
