...
const en = {
  ...
  settings: {
    ...
    backup: {
      ...
      importNeedsIntegrationAuth: "Re-enter credentials for imported service plugins under Plugins.",
      importNeedsAuthBoth: "Re-enter credentials for imported channels and service plugins.",
