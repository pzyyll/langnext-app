...
Merges an arbitrary number of React props using the same logic as [`mergeProps`](./merge-props.md).
This function accepts an array of props instead of individual arguments.

This has slightly lower performance than [`mergeProps`](./merge-props.md) due to accepting an array
instead of a fixed number of arguments. Prefer [`mergeProps`](./merge-props.md) when merging 5 or
