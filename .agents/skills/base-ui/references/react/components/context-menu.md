...
[Menu](./menu.md) displays additional demos, many of which apply to the context menu as well.
...
Re-export of [Root](./context-menu.md) props.
...
Re-export of [Trigger](./context-menu.md) props.
...
Re-export of [Portal](./context-menu.md) props.
...
Re-export of [Backdrop](./context-menu.md) props.
...
Re-export of [Positioner](./context-menu.md) props.
...
Re-export of [Popup](./context-menu.md) props.
...
Re-export of [Arrow](./context-menu.md) props.
...
Re-export of [Item](./context-menu.md) props.
...
Re-export of [Group](./context-menu.md) props.
...
Re-export of [GroupLabel](./context-menu.md) props.
...
Re-export of [Separator](./context-menu.md) props.
...
Re-export of [SubmenuRoot](./context-menu.md) props.
...
Re-export of [SubmenuTrigger](./context-menu.md) props.
...
Re-export of [RadioGroup](./context-menu.md) props.
...
Re-export of [RadioItem](./context-menu.md) props.
...
Re-export of [RadioItemIndicator](./context-menu.md) props.
...
Re-export of [CheckboxItem](./context-menu.md) props.
...
Re-export of [CheckboxItemIndicator](./context-menu.md) props.
...
Re-export of [LinkItem](./context-menu.md) props.
