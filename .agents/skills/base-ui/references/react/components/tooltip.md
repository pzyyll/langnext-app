...
- **Prefer using tooltips as visual labels only**: Tooltips should act as supplementary visual labels for sighted mouse and keyboard users. Tooltips alone are not accessible to touch or screen reader users. See [Alternatives to tooltips](./tooltip.md) for more details.
...
Popups that open when hovering an info icon should use [Popover](./popover.md) with the `openOnHover` prop on the trigger instead of a tooltip. This way, touch users and screen reader users can access the content.
...
Use the Toast component's [anchoring ability](./toast.md) for more ergonomic DX, to ensure the message is announced to screen readers, and to support complex content.
...
Re-export of [Root](./tooltip.md) props.
...
Re-export of [Provider](./tooltip.md) props.
...
Re-export of [Trigger](./tooltip.md) props.
...
Re-export of [Portal](./tooltip.md) props.
...
Re-export of [Positioner](./tooltip.md) props.
...
Re-export of [Popup](./tooltip.md) props.
...
Re-export of [Arrow](./tooltip.md) props.
...
Re-export of [Viewport](./tooltip.md) props.
