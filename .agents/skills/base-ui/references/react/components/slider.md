...
- **Form controls must have an accessible name**: Prefer `<Slider.Label>`, or provide an `aria-label` on each `<Slider.Thumb>` when no visible label is rendered. See [Labeling a slider](./slider.md) and the [forms guide](../handbook/forms.md).
...
For grouped multi-thumb range sliders in forms, [Fieldset](./fieldset.md) can provide the shared visible label while each thumb keeps its own `aria-label`:
...
Re-export of [Root](./slider.md) props.
...
Re-export of [Value](./slider.md) props.
...
Re-export of [Indicator](./slider.md) props.
...
Re-export of [Track](./slider.md) props.
...
Re-export of [Thumb](./slider.md) props.
...
Re-export of [Control](./slider.md) props.
...
Re-export of [Label](./slider.md) props.
