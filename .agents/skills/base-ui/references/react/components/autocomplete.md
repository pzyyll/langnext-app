...
- **Avoid when selection state is needed**: Use [Combobox](./combobox.md) instead of Autocomplete if the selection should be remembered and the input value cannot be custom. Unlike Combobox, Autocomplete's input can contain free-form text, as its suggestions only _optionally_ autocomplete the text.
...
- **Form controls must have an accessible name**: It can be created using a `<label>` element or the `Field` component. See the [forms guide](../handbook/forms.md).
...
Re-export of [Root](./autocomplete.md) props.
...
Re-export of [Trigger](./autocomplete.md) props.
...
Re-export of [Value](./autocomplete.md) props.
...
Re-export of [Input](./autocomplete.md) props.
...
Re-export of [Icon](./autocomplete.md) props.
...
Re-export of [Clear](./autocomplete.md) props.
...
Re-export of [List](./autocomplete.md) props.
...
Re-export of [Portal](./autocomplete.md) props.
...
Re-export of [Backdrop](./autocomplete.md) props.
...
Re-export of [Positioner](./autocomplete.md) props.
...
Re-export of [Popup](./autocomplete.md) props.
...
Re-export of [Arrow](./autocomplete.md) props.
...
Re-export of [Item](./autocomplete.md) props.
...
Re-export of [Group](./autocomplete.md) props.
...
Re-export of [GroupLabel](./autocomplete.md) props.
...
Re-export of [Separator](./autocomplete.md) props.
...
Re-export of [Status](./autocomplete.md) props.
...
Re-export of [Empty](./autocomplete.md) props.
...
Re-export of [Collection](./autocomplete.md) props.
...
Re-export of [Row](./autocomplete.md) props.
...
Re-export of [InputGroup](./autocomplete.md) props.
