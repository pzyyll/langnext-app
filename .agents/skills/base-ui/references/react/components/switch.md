...
- **Form controls must have an accessible name**: It can be created using a `<label>` element or the `Field` component. See [Labeling a switch](./switch.md) and the [forms guide](../handbook/forms.md).
...
Re-export of [Root](./switch.md) props.
...
Re-export of [Thumb](./switch.md) props.
