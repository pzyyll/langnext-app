...
- **Form controls must have an accessible name**: It can be created using a `<label>` element or the `Field` component. See [Labeling a checkbox](./checkbox.md) and the [forms guide](../handbook/forms.md).
...
Re-export of [Root](./checkbox.md) props.
...
Re-export of [Indicator](./checkbox.md) props.
