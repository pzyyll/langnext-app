...
- **Prefer Combobox for large lists**: Select is not filterable, aside from basic keyboard typeahead functionality to find items by focusing and highlighting them. Prefer [Combobox](./combobox.md) instead of Select when the number of items is sufficiently large to warrant filtering.
- **Special positioning behavior**: The select popup by default overlaps its trigger so the selected item's text is aligned with the trigger's value text. This behavior [can be disabled or customized](./select.md).
- **Form controls must have an accessible name**: Prefer `<Select.Label>`, or provide an `aria-label` on `<Select.Trigger>` when no visible label is rendered. See [Labeling a select](./select.md) and the [forms guide](../handbook/forms.md).
...
To avoid lookup, [object values](./select.md) for each item can also be used.
...
Re-export of [Root](./select.md) props.
...
Re-export of [Trigger](./select.md) props.
...
Re-export of [Value](./select.md) props.
...
Re-export of [Icon](./select.md) props.
...
Re-export of [List](./select.md) props.
...
Re-export of [Portal](./select.md) props.
...
Re-export of [Backdrop](./select.md) props.
...
Re-export of [Positioner](./select.md) props.
...
Re-export of [Popup](./select.md) props.
...
Re-export of [Arrow](./select.md) props.
...
Re-export of [Item](./select.md) props.
...
Re-export of [Group](./select.md) props.
...
Re-export of [GroupLabel](./select.md) props.
...
Re-export of [Separator](./select.md) props.
...
Re-export of [Label](./select.md) props.
...
Re-export of [ItemText](./select.md) props.
...
Re-export of [ItemIndicator](./select.md) props.
...
Re-export of [ScrollUpArrow](./select.md) props.
...
Re-export of [ScrollDownArrow](./select.md) props.
