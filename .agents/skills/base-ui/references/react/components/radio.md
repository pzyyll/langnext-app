...
- **Form controls must have an accessible name**: It can be created using `<label>` elements, or the `Field` and `Fieldset` components. See [Labeling a radio group](./radio.md) and the [forms guide](../handbook/forms.md).
...
Re-export of [RadioGroup](./radio.md) props.
...
Re-export of [Root](./radio.md) props.
...
Re-export of [Indicator](./radio.md) props.
