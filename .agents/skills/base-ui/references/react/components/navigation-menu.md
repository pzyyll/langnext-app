...
Native scrollbars are visible while transitioning content, so we recommend using the [Scroll Area](./scroll-area.md) component instead of native scrollbars to keep them hidden, which also allows the `Arrow` to be centered correctly.
...
Re-export of [Root](./navigation-menu.md) props.
...
Re-export of [Trigger](./navigation-menu.md) props.
...
Re-export of [Icon](./navigation-menu.md) props.
...
Re-export of [List](./navigation-menu.md) props.
...
Re-export of [Portal](./navigation-menu.md) props.
...
Re-export of [Backdrop](./navigation-menu.md) props.
...
Re-export of [Positioner](./navigation-menu.md) props.
...
Re-export of [Popup](./navigation-menu.md) props.
...
Re-export of [Arrow](./navigation-menu.md) props.
...
Re-export of [Item](./navigation-menu.md) props.
...
Re-export of [Content](./navigation-menu.md) props.
...
Re-export of [Viewport](./navigation-menu.md) props.
...
Re-export of [Link](./navigation-menu.md) props.
