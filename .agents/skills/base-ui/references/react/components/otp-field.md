...
- **Form controls must have an accessible name**: It can be created using a `<label>` element or the `Field` component. See [Labeling an OTP field](./otp-field.md) and the [forms guide](../handbook/forms.md).
...
Use [Field](./field.md) to handle label associations and form integration:
...
Re-export of [Root](./otp-field.md) props.
...
Re-export of [Input](./otp-field.md) props.
...
Re-export of [Separator](./otp-field.md) props.
