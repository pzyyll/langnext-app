...
Re-export of [Root](./preview-card.md) props.
...
Re-export of [Trigger](./preview-card.md) props.
...
Re-export of [Portal](./preview-card.md) props.
...
Re-export of [Backdrop](./preview-card.md) props.
...
Re-export of [Positioner](./preview-card.md) props.
...
Re-export of [Popup](./preview-card.md) props.
...
Re-export of [Arrow](./preview-card.md) props.
...
Re-export of [Viewport](./preview-card.md) props.
