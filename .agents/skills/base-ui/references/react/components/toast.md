...
Each of the states also accepts the [method options](./toast.md) object for more granular control.
...
Re-export of [Root](./toast.md) props.
...
Re-export of [Provider](./toast.md) props.
...
Re-export of [Portal](./toast.md) props.
...
Re-export of [Positioner](./toast.md) props.
...
Re-export of [Arrow](./toast.md) props.
...
Re-export of [Content](./toast.md) props.
...
Re-export of [Title](./toast.md) props.
...
Re-export of [Description](./toast.md) props.
...
Re-export of [Close](./toast.md) props.
...
Re-export of [Action](./toast.md) props.
...
Re-export of [Viewport](./toast.md) props.
...
Each state also accepts the [method options](./toast.md) object to granularly control the toast for each state:
...
See full [`promise` method](./toast.md)
