...
- **Combobox is a filterable Select**: Use Combobox when the input is restricted to a set of predefined selectable items, similar to [Select](./select.md) but whose items are filterable using an input. Prefer using Combobox over Select when the number of items is sufficiently large to warrant filtering.
- **Avoid for simple search widgets**: Combobox does not allow free-form text input. For search widgets, consider using [Autocomplete](./autocomplete.md) instead.
- **Avoid when not rendering an input**: Use [Select](./select.md) instead of Combobox if no input is being rendered, which includes accessibility features specific to a listbox without an input.
- **Form controls must have an accessible name**: If `<Combobox.Input>` is the form control, label it with a native `<label>` or `<Field.Label>`, or provide an `aria-label` when no visible label is rendered. `<Combobox.Label>` labels `<Combobox.Trigger>` and is intended for the [input-inside-popup](./combobox.md) pattern, where the trigger is the form control. See the [forms guide](../handbook/forms.md).
...
Re-export of [Root](./combobox.md) props.
...
Re-export of [Trigger](./combobox.md) props.
...
Re-export of [Value](./combobox.md) props.
...
Re-export of [Input](./combobox.md) props.
...
Re-export of [Icon](./combobox.md) props.
...
Re-export of [Clear](./combobox.md) props.
...
Re-export of [List](./combobox.md) props.
...
Re-export of [Portal](./combobox.md) props.
...
Re-export of [Backdrop](./combobox.md) props.
...
Re-export of [Positioner](./combobox.md) props.
...
Re-export of [Popup](./combobox.md) props.
...
Re-export of [Arrow](./combobox.md) props.
...
Re-export of [Item](./combobox.md) props.
...
Re-export of [Group](./combobox.md) props.
...
Re-export of [GroupLabel](./combobox.md) props.
...
Re-export of [Separator](./combobox.md) props.
...
Re-export of [Label](./combobox.md) props.
...
Re-export of [Status](./combobox.md) props.
...
Re-export of [Empty](./combobox.md) props.
...
Re-export of [Collection](./combobox.md) props.
...
Re-export of [Row](./combobox.md) props.
...
Re-export of [Chips](./combobox.md) props.
...
Re-export of [Chip](./combobox.md) props.
...
Re-export of [ChipRemove](./combobox.md) props.
...
Re-export of [ItemIndicator](./combobox.md) props.
...
Re-export of [InputGroup](./combobox.md) props.
