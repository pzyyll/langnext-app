...
This demo shows you how to import a [Popover](../components/popover.md) component, assemble its parts, and apply styles.
...
Take a look at the [Community](./community.md) page to see more styled libraries powered by Base UI.
...
Continue to the [Handbook](../handbook/styling.md) section for broader guidance on topics like styling, animation, and composition, or explore the [components](../components/accordion.md).
